...
export function About() {
  return (
    <Section id="about" eyebrow="About" title="A product mindset, applied to frontend architecture">
      <div className="grid gap-10 lg:grid-cols-[2fr_1fr]">
        ...
        <dl className="h-fit space-y-4 rounded-2xl border border-line bg-raised p-6">
          ...
          <div>
            ...
            <dd className="mt-1 text-sm text-body">
              Frontend architecture · performance · mentoring · enterprise reliability
            </dd>
          </div>
          <div>
            <dt className="font-mono text-xs uppercase tracking-[0.18em] text-soft">Open to</dt>
            <dd className="mt-1 text-sm text-body">
              Senior frontend roles, remote-first teams, and high-stakes product work
            </dd>
          </div>
        </dl>
      </div>
